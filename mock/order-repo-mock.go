...
func (m *MockOrderRepo) AddProduct(arg0 iface.Itx, arg1 *model.ProductInOrder) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) GetDb() iface.Idb {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDb")
	ret0, _ := ret[0].(iface.Idb)
	return ret0
}
...
func (m *MockOrderRepo) GetOrderStatus(tx iface.Itx, orderId string) (uint8, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) GetPaymentsSumByOrderId(tx iface.Itx, orderId string) (float32, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) GetProductId(tx iface.Itx, p *model.ProductInOrder) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) GetProductsPriceSumByOrderId(tx iface.Itx, orderId string) (float32, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) UpdateOrderStatusToComplete(tx iface.Itx, orderId string) error {
	m.ctrl.T.Helper()
...
func (m *MockOrderRepo) UpdateProductNumById(tx iface.Itx, num, id uint) error {
	m.ctrl.T.Helper()
